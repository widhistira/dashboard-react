...
const AppBarComp = (props) => {
  ...
  const { open, handleDrawerToggle, handleRightPanelOpen } = React.useContext(NavigationContext);
    ...
    <AppBar
      ...
      <Toolbar>
        ...
        <div className={classes.appbarSection}>
          <IconButton
            aria-haspopup="true"
            onClick={() => (curThemeName === 'dark' ? setThemeName('light') : setThemeName('dark'))}
            color="inherit">
            {curThemeName === 'dark' ? <Brightness7Icon /> : <Brightness4Icon />}
          </IconButton>
