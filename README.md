...
[React](https://reactjs.org/) is the core of our template. If you don't know what React is or don't know how to use it, we strongly recommend checking the React before start doing anything with .
...
![ - React Admin](https://vitateach.com/wp-content/uploads/2020/04/project-structure-.png)
...
Completely free (MIT)! See [LICENSE.md](https://github.com/mohammad/-react-admin/blob/master/LICENSE) for more.

## Donate

You can donate to us. [link for donate](https://paypal.me/Mohammad?locale.x=en_US)
